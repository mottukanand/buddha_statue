  ...
  return (
    <>
      <div className="flex-container relative-pos">
        <div
          className={toggleSideBar ? "flex-item-left active" : "flex-item-left"}
        >
          <div className="content">
            <div className="custom-icon center mb-35">
            ...
            <div className="mb-35">
              ...
              <p className="description">
                ...
                Maitreya is he eighth Buddha, a successor of the seven,
                ...
                wears a heavily adorned with earings, wristlets, necklace, and
                an amulet. The
              </p>
            </div>
        ...
        <div
          className={
            toggleSideBar
              ? "flex-item-right center h-100"
              : "flex-item-right center"
          }
        >
        ...
        <div
          className={
            toggleSideBar ? "close-open-menu left-0" : "close-open-menu"
          }
